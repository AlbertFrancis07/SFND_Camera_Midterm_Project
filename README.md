...
MP.8) For every consecutive images, the number of keypoint pairs that were matched(from MP.6) was counted using 'matches.size()'
...
These provide the best balance between speed and total number of detections making it suitable for real time applications. 